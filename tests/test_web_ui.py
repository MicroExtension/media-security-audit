...
class WebUiTests(unittest.TestCase):
    ...
    def test_wizard_template_exposes_guided_audit_flow(self) -> None:
        ...
        self.assertIn('aria-label="Profils rapides d\'audit"', template)
        self.assertIn("wizard-profile-strip", template)
        self.assertIn("wizard-profile-grid", template)
        self.assertIn("wizard-profile-card", template)
        self.assertIn("data-wizard-profile", template)
        self.assertIn("data-wizard-profile-type", template)
        self.assertIn("data-wizard-profile-checks", template)
        self.assertIn("Audit Interne LAN", template)
        self.assertIn("Externe Web/Mail", template)
        self.assertIn("AD / LDAP", template)
        self.assertIn("Complet Prudent", template)
        self.assertIn('data-wizard-profile-checks="nmap,smb,ldap"', template)
        self.assertIn('data-wizard-profile-checks="http_headers,dns_mail,tls"', template)
        self.assertIn('data-wizard-profile-checks="nmap,http_headers,dns_mail,tls,smb,ldap"', template)
        self.assertIn("Profil applique. Renseigne maintenant les cibles autorisees.", template)
        ...
        self.assertIn('aria-label="Assistant cibles attendues"', template)
        self.assertIn("wizard-target-coach", template)
        self.assertIn("wizard-target-coach-grid", template)
        self.assertIn("data-wizard-target-coach-summary", template)
        self.assertIn("data-wizard-target-card", template)
        self.assertIn("data-wizard-target-card-status", template)
        self.assertIn("data-wizard-target-card-count", template)
        self.assertIn("data-wizard-target-jump", template)
        self.assertIn("Cibles Attendues", template)
        self.assertIn("Reseaux / IP / Hotes", template)
        self.assertIn("Necessaire pour Nmap et SMB.", template)
        self.assertIn("Domaines Publics", template)
        self.assertIn("Necessaire pour DNS/Mail.", template)
        self.assertIn("URLs Web", template)
        self.assertIn("Necessaire pour HTTP headers et TLS Web.", template)
        self.assertIn("Necessaire pour LDAP.", template)
        self.assertIn(".wizard-target-guidance", css)
        self.assertIn(".wizard-target-coach", css)
        self.assertIn(".wizard-target-coach-grid", css)
        self.assertIn(".wizard-target-card", css)
        self.assertIn(".wizard-target-card.is-required", css)
        self.assertIn(".wizard-target-card.is-ready", css)
        self.assertIn(".wizard-target-card.is-missing", css)
        ...
        self.assertIn('aria-label="Assistant services a tester"', template)
        self.assertIn('aria-label="Presets de controles"', template)
        self.assertIn("wizard-service-coach", template)
        self.assertIn("wizard-check-preset-grid", template)
        self.assertIn("wizard-service-coach-list", template)
        self.assertIn("data-wizard-check-preset", template)
        self.assertIn("data-wizard-service-coach-summary", template)
        self.assertIn("data-wizard-service-coach-list", template)
        self.assertIn("Selection Rapide Des Services", template)
        self.assertIn("Socle LAN", template)
        self.assertIn("Web / Mail", template)
        self.assertIn("Annuaire", template)
        self.assertIn("Tout Prudent", template)
        self.assertIn('data-wizard-checks="nmap,smb"', template)
        self.assertIn('data-wizard-checks="http_headers,dns_mail,tls"', template)
        ...
        self.assertIn('aria-label="Decision avant creation"', template)
        self.assertIn("wizard-final-readiness", template)
        self.assertIn("wizard-final-status", template)
        self.assertIn("wizard-final-metrics", template)
        self.assertIn("wizard-final-next", template)
        self.assertIn("data-wizard-final-readiness", template)
        self.assertIn("data-wizard-final-status-pill", template)
        self.assertIn("data-wizard-final-status-title", template)
        self.assertIn("data-wizard-final-status-detail", template)
        self.assertIn("data-wizard-final-client", template)
        self.assertIn("data-wizard-final-mission", template)
        self.assertIn("data-wizard-final-targets", template)
        self.assertIn("data-wizard-final-services", template)
        self.assertIn("Decision avant creation", template)
        self.assertIn("Apres creation", template)
        self.assertIn("Ouvrir la console d'audit pour le Go/No-Go.", template)
        self.assertIn("Lancer uniquement les controles explicitement autorises.", template)
        ...
        self.assertIn("const profileButtons = [...document.querySelectorAll(\"[data-wizard-profile]\")]", template)
        self.assertIn("const applyProfile = (button) =>", template)
        self.assertIn("profileButtons.forEach((button) =>", template)
        self.assertIn("checkbox.checked = checks.includes(checkbox.dataset.wizardCheck || \"\")", template)
        ...
        self.assertIn("const targetFieldsForSelectedChecks = () =>", template)
        self.assertIn("const targetLineCountForField = (fieldName) =>", template)
        self.assertIn("const renderTargetCoach = () =>", template)
        self.assertIn("targetCoachSummary.textContent = requiredCount", template)
        self.assertIn("targetJumpButtons.forEach((button) =>", template)
        self.assertIn("const renderServiceCoach = () =>", template)
        self.assertIn("serviceCoachSummary.textContent = `${readyCount}/${coverage.length} services prets`", template)
        self.assertIn("const applyCheckPreset = (button) =>", template)
        self.assertIn("checkPresetButtons.forEach((button) =>", template)
        self.assertIn("const readinessBlockers = (state) =>", template)
        self.assertIn("const updateFinalReadiness = (state, snapshot) =>", template)
        self.assertIn("finalReadiness.classList.toggle(\"is-ready\", ready)", template)
        self.assertIn("finalStatusDetail.textContent = ready", template)
        ...
        self.assertIn("renderTargetCoach();", template)
        self.assertIn("renderServiceCoach();", template)
        self.assertIn("updateFinalReadiness(state", template)
        ...
        self.assertIn(".wizard-profile-strip", css)
        self.assertIn(".wizard-profile-head", css)
        self.assertIn(".wizard-profile-grid", css)
        self.assertIn(".wizard-profile-card", css)
        self.assertIn(".wizard-profile-card.is-active", css)
        ...
        self.assertIn(".wizard-service-coach", css)
        self.assertIn(".wizard-check-preset-grid", css)
        self.assertIn(".wizard-check-preset-grid button.is-active", css)
        self.assertIn(".wizard-service-coach-list", css)
        self.assertIn(".wizard-service-coach-item", css)
        self.assertIn(".wizard-service-coach-item.is-ready", css)
        self.assertIn(".wizard-service-coach-item.is-missing", css)
        ...
        self.assertIn(".wizard-final-readiness", css)
        self.assertIn(".wizard-final-readiness.is-ready", css)
        self.assertIn(".wizard-final-status", css)
        self.assertIn(".wizard-final-metrics", css)
        self.assertIn(".wizard-final-next", css)
    ...
    def test_session_dashboard_template_exposes_analysis_progress(self) -> None:
        ...
        self.assertIn('aria-label="Session progress summary"', template)
        self.assertIn('aria-label="Analysis session counters"', template)
        self.assertIn('aria-label="Session command center"', template)
        ...
        self.assertIn('aria-label="Session remediation priorities"', template)
        ...
        self.assertIn("view.session_dashboard.ready_step_count", template)
        self.assertIn("view.session_dashboard.needs_attention_step_count", template)
        self.assertIn("view.session_dashboard.blocked_step_count", template)
        self.assertIn("view.session_dashboard.total_step_count", template)
        ...
        self.assertIn('aria-label="Session execution queue"', template)
        self.assertIn("File D'Execution", template)
        self.assertIn("Explication simple", template)
        self.assertIn("Pourquoi c'est important", template)
        ...
        self.assertIn("session-priority-card", template)
        self.assertIn("view.go_no_go.decision", template)
        ...
        self.assertIn("session-command-card", template)
        self.assertIn("session-command-{{ view.go_no_go.status }}", template)
        self.assertIn("session-command-{{ view.scan_run_outcome.status }}", template)
        self.assertIn("session-command-{{ view.vulnerability_summary.status }}", template)
        self.assertIn("session-command-{{ view.report_delivery.status }}", template)
        self.assertIn("Preparation", template)
        ...
        self.assertIn(".session-workflow-board", css)
        self.assertIn(".session-workflow-grid", css)
        self.assertIn(".session-workflow-card", css)
        self.assertIn(".session-workflow-ready", css)
        self.assertIn(".session-workflow-blocked", css)
        self.assertIn(".session-result-explorer", css)
        self.assertIn(".session-result-grid", css)
        ...
        self.assertIn(".session-execution-queue", css)
        self.assertIn(".session-execution-card", css)
        self.assertIn(".session-execution-completed", css)
        self.assertIn(".session-explainer-board", css)
        self.assertIn(".session-explainer-card", css)
        self.assertIn(".session-explainer-high", css)
        self.assertIn(".session-priority-board", css)
        self.assertIn(".session-priority-card", css)
        self.assertIn(".session-priority-critical", css)
        self.assertIn(".session-priority-high", css)
    ...
    def test_mission_view_orders_scope_findings_and_remediation(self) -> None:
        ...
        self.assertEqual(view.session_dashboard.total_step_count, 7)
        self.assertGreaterEqual(view.session_dashboard.ready_step_count, 3)
        self.assertGreaterEqual(view.session_dashboard.needs_attention_step_count, 1)
        self.assertEqual(view.session_dashboard.blocked_step_count, 0)
        self.assertTrue(view.session_dashboard.next_action_detail)
        self.assertEqual(
            [lane.label for lane in view.session_dashboard.workflow_lanes],
            ["Decouverte", "Execution", "Analyse", "Restitution"],
        )
        execution_lane = view.session_dashboard.workflow_lanes[1]
        self.assertEqual(execution_lane.status, "warning")
        self.assertEqual(execution_lane.primary_value, "1")
        self.assertEqual(execution_lane.secondary_value, "1/3")
        self.assertEqual(
            [item.label for item in view.session_dashboard.result_shortcuts],
            ["Cibles", "Services", "Executions", "CVE/KEV", "Constats", "Livrables"],
        )
        execution_result = view.session_dashboard.result_shortcuts[2]
        ...
        self.assertEqual(len(view.session_dashboard.execution_queue), 3)
        nmap_queue = next(
            item
            for item in view.session_dashboard.execution_queue
            if item.check == "nmap"
        )
        self.assertEqual(nmap_queue.status, "completed")
        self.assertEqual(nmap_queue.planned_command_count, 1)
        self.assertEqual(nmap_queue.last_run_status, "completed")
        ...
        self.assertEqual(len(view.session_dashboard.finding_explainers), 1)
        explainer = view.session_dashboard.finding_explainers[0]
        self.assertEqual(explainer.title, "Open administrative service")
        self.assertEqual(explainer.severity, "high")
        self.assertEqual(explainer.asset, "192.0.2.10")
        self.assertIn("service d'administration distant", explainer.plain_explanation)
        self.assertIn("Impact prioritaire", explainer.why_it_matters)
        self.assertEqual(explainer.remediation, "Restrict access to trusted sources.")
        self.assertEqual(explainer.validation, "Run the approved Nmap plan again.")
        self.assertEqual(explainer.action_href, "#session-findings")
